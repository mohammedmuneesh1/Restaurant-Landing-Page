...
export default function Work() {
  return (
    <div className='mt-52  pb-4'>
        ...
        <h1 className='text-gray-600  font-extrabold  tracking-normal sm:tracking-wider text-3xl sm:text-5xl md:text-6xl '>How It Works</h1>
        ...
        <div id='work-icons' className=' flex flex-row mt-12 justify-center items-center flex-wrap'>
