...
export default function Work() {
  return (
    <div className='mt-16 sm:mt-36 md:mt-44 lg:mt-48  pb-4'>
        ...
        <p className=' text-gray-500  text-justify max-w-2xl my-3 sm:my-6  tracking-normal sm:tracking-wider text- sm:text-xl md:text-2xl '>Welcome to <span className='font-semibold'> FreshBite! </span> Our passionate chefs carefully select fresh ingredients to craft mouthwatering dishes, while our friendly staff provides attentive service to ensure a delightful dining experience. Join us and savor the magic of exceptional cuisine in a welcoming atmosphere.</p>
        </div> 
